    ...
    <div class="container mt-3 mb-5 mx-auto shadow " style="max-width:40vw;background:#fff; border-radius: 30px;">
        <form method="post" class="p-5">
            <div class="mb-3">
                ...
                <input type="text" class="form-control  " placeholder="Nguyễn Văn A..." name="name" value="<?php echo isset($name) ? $name : "" ?>">
            </div>
            <div class="mb-3">
                <label class="form-label fw-bold">Mã số sinh viên:</label>
                <input type="text" class="form-control " placeholder=" B1900000..." name="stcode" minlength="8" maxlength="8" value=<?php echo isset($stcode) ? $stcode : "" ?>>
            </div>
            <div class="mb-3">
                <label class="form-label fw-bold">Lớp:</label>
                <input type="text" class="form-control " placeholder="20V7A2..." name="class" minlength="6" maxlength="6" value=<?php echo isset($class) ? $class : "" ?>>
            </div>
            <div class="mb-3">
            ...
            <div>
                <button class="btn btn-primary px-4 mt-2 text-capitalize rounded-pill w-100" name="update" style="font-size:18px">
